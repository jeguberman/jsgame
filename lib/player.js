...
class Player extends MovingObject{
  ...
  constructor(options){
    ...
    this.imageX = 10;
    this.imageY = 50;
    this.image.src = '/Users/johnguberman/workspace/App Academy/job_search/jsgame/assets/SNES - Super Mario World - Mario.png';
  }
  ...
  draw(ctx){
    ...
    ctx.drawImage(this.image, this.imageX, this.imageY, this.width, this.height, this.pos[0], this.pos[1], this.width, this.height);
    ctx.restore();
  }
